...
public class US449_VisitManagement {
    ...
    public void the_user_should_see_exactly_options_under_the_actions_dropdown(Integer int1) {
        // Write code here that turns the phrase above into concrete actions

    }

    @When("the user clicks on the active visit")
    public void the_user_clicks_on_the_active_visit() {
        // Write code here that turns the phrase above into concrete actions
